...
function Homepage() {
    ...
    return (
        ...
        <Container className={`userForm  hide`} transition={".5s"} maxW={{ base: 'full', md: "md" }} pos={"fixed"} right={0} minH={{ base: "fit-content", md: "100vh" }} bg="white" boxShadow={"0 0 10px rgba(0,0,0,.2)"}>
